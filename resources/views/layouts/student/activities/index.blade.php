...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <a href="#" class="btn btn-primary mb-3" id="btn-add-activities">
    ...
    @include('layouts.student.activities.modal-form')
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.get('/student/activities/get-mbkm', function(res) {
                console.log(res);
                if (res.length > 0) {
            ...
            $('#activities-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('student.activities.data') }}',
                columns: [{
                        data: 'no',
                        name: 'no',
                        orderable: false,
        ...
        $(function() {
            ...
            $('#btn-add-activities').on('click', function() {
                form.trigger('reset');
                $('#data-id').val('');
            ...
            form.on('submit', function(e) {
                ...
                const url = id ? `/student/activities/${id}` : `/student/activities`;
            ...
            $('#activities-table').on('click', '.btn-edit', function() {
                ...
                $.get(`/student/activities/${id}/edit`, function(res) {
            ...
            $('#activities-table').on('click', '.btn-delete', function(e) {
                e.preventDefault();
                const id = $(this).data('id');

                if (confirm('Apakah kamu yakin ingin menghapus logbook ini?')) {
                    $.ajax({
                        url: `/student/activities/${id}`,
                        method: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
